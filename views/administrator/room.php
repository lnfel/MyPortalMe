                                ...
                                <?php //if($result->num_rows > 0){ ?><?php //if($result->num_rows > 0){ ?>
                                    <?php foreach ($cat_room as $emp) { ?>
                                        <tr     >
                                                ...
                                                <td style="vertical-align: middle;"> <?php echo $emp->RoomCode; ?></td>
...
<!--                                                        <div class="btn-group mb-2">
                                                            ...
                                                            <a href="<?php echo base_url('administrator/room_view/'.$emp->RoomID); ?>" class="btn btn-info btn-sm">View <i class="fa fa-file"></i></a>
