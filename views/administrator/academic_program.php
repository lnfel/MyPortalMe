                    ...
                    <div class="row" >
                            <div class="col-md-2">
                                    <div class="form-group">
                                            <select class="form-control" name="cat_keyword" data-toggle="tooltip" data-placement="top" title="Select Category">
                                                            <option value="AcademicID">Academic ID</option>
                                                            <option value="AcademicCode">Academic Code</option>
                                                            <option value="AcademicName">Academic Name</option>
                            ...
                            <div class="col-md-10">
                                    <div class="input-group mb-3">
                                            <input type="text" class="form-control" name="keyword" placeholder="Search Academic Program" data-toggle="tooltip" data-placement="top" title="Search Academic Program">
                   ...
                   <div style="height:620px;overflow:auto;">
                        <table class="table table-striped table-hover">
                            ...
                            <?php //if($result->num_rows > 0){ ?><?php //if($result->num_rows > 0){ ?>
                                    <?php foreach ($cat_academic_program as $emp) { ?>
                                        <tr     >
                                                <th style="vertical-align: middle;"><?php //echo $i++; ?></th>
                                                <td style="vertical-align: middle;"> <?php echo $emp->AcademicCode; ?></td>
                                                <td style="vertical-align: middle;"> <?php echo $emp->AcademicName; ?></td>
...
<!--                                                        <div class="btn-group mb-2">
                                                            ...
                                                            <a href="<?php echo base_url('administrator/academic_program_view/'.$emp->AcademicID); ?>" class="btn btn-info btn-sm">View <i class="fa fa-file"></i></a>
                                                            <a href="<?php echo base_url('administrator/academic_program_edit/'.$emp->AcademicID); ?>" class="btn btn-warning btn-sm" >Edit <i class="fa fa-edit"></i></a>
                                                            <a href="<?php echo base_url('administrator/academic_program_delete/'.$emp->AcademicID); ?>" class="btn btn-danger btn-sm"  onclick="return confirm('Are you sure you want to delete?');">Delete <i class="fa fa-trash"></i></a>
                                                </center>
                                                </td>
                                        </tr>
                                        <?php  }  ?>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row" >
                                    <div class="col-md-12">
                                            <div class="row">
                                                    <div class="col-md-12">
                                                            <label style="font-weight:bold;">Academic ID</label>
                                                            <input type="text" name="AcademicID" class="form-control" value="" placeholder="Academic ID" data-toggle="tooltip" data-placement="top" title="Academic ID" onkeyup="this.value = this.value.toUpperCase()" required>
                                                            <label style="font-weight:bold;">Academic Code</label>
                                                            <input type="text" name="AcademicCode" class="form-control" value="" placeholder="Academic Code" data-toggle="tooltip" data-placement="top" title="Academic Code" onkeyup="this.value = this.value.toUpperCase()" required>
                                                            <label style="font-weight:bold;">Academic Name</label>
                                                            <input type="text" name="AcademicName" class="form-control" value="" placeholder="Academic Name" data-toggle="tooltip" data-placement="top" title="Sear Capacity" onkeyup="this.value = this.value.toUpperCase()">
