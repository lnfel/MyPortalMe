                    ...
                    <div class="row" >
                            ...
                            <div class="col-md-10">
                                    <div class="input-group mb-3">
                                            <input type="text" class="form-control" name="keyword" placeholder="Search Student" data-toggle="tooltip" data-placement="top" title="Search Student">
                            ...
                            <div class="row" >
                                    <div class="col-md-12">
                                            <div class="row">
                                                    ...
                                                    <select name="ActiveStatus" class="form-control input-sm" placeholder="Active Status" data-toggle="tooltip" data-placement="top" title="ActiveStatus" onkeyup="this.value = this.value.toUpperCase()">
                                                    <?php 
                                                                //$result_studenttype = $conn->query("SELECT * FROM student_type") or die($conn->error);
                                                                //$row_studenttype = $result_studenttype->fetch_assoc();
                                                     ?>    
                                                        <option>0 - Inactive</option>
                                                        <option>1 - Active</option>     
                                                        <?php //do { ?>
                                                                <option value="<?php //echo $row_studenttype['studentTypeID']; ?>"><?php //echo $row_studenttype['studentType']; ?></option>
                                                        <?php //} while ($row_studenttype = $result_studenttype->fetch_assoc()); ?>

                                                    </select>  
                                                    <label style="font-weight:bold;">Course ID</label>
                                                    <input type="text" name="CourseID" class="form-control input-sm" value="" placeholder="Course ID" data-toggle="tooltip" data-placement="top" title="CourseID" onkeyup="this.value = this.value.toUpperCase()">
