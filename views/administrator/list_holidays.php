                    ...
                    <div class="row" >
                            <div class="col-md-2">
                                    <div class="form-group">
                                            <select class="form-control" name="cat_keyword" data-toggle="tooltip" data-placement="top" title="Select Category">
                                                            <option value="HolidayID">Holiday ID</option>
                            ...
                            <div class="col-md-10">
                                    <div class="input-group mb-3">
                                            <input type="text" class="form-control" name="keyword" placeholder="Search Holiday " data-toggle="tooltip" data-placement="top" title="Search Holiday ">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <?php //if($result->num_rows > 0){ ?><?php //if($result->num_rows > 0){ ?>
                                    <?php foreach ($list_holiday as $emp) { ?>
                                        <tr     >
                                                <td style="vertical-align: middle;"> <?php echo $emp->ID; ?></td>
...
<!--                                                        <div class="btn-group mb-2">
                                                            ...
                                                            <a href="<?php echo base_url('administrator/list_holiday_view/'.$emp->ID); ?>" class="btn btn-info btn-sm">View <i class="fa fa-file"></i></a>
