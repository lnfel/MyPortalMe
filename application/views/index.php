      ...
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3">
            ...
            <form method="POST" action="site" class="needs-validation" novalidate="">
                <div class="alert alert-danger alert-dismissible show fade"  <?php if ($alert == 1) {} else { echo 'style="display:none;"'; } ?>>
                  <div class="alert-body">
                    <button class="close" data-dismiss="alert">
                      <span>&times;</span>
                    </button>
                    <i class="fa fa-warning"></i> <small><b>Invalid Username / Password.</b></small>
                  </div>
                </div>
              ...
              <div class="form-group text-right">
                <a href="auth-forgot-password.html" class="float-left mt-3">
                  ...
                  <button type="submit" name="login" class="btn btn-primary btn-lg btn-icon icon-right" tabindex="3">
                  Login
                </button>
              </div>
