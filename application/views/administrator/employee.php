                                                ...
                                                <td>
                                                     <center>
                                                        ...
                                                        <?php if (file_exists($filename)) { ?>
                                                         <img src="<?php echo base_url(); ?>site_source/employee_picture/<?php echo $emp->EmployeeNo;?>.png" class="rounded-circle" style="width:100px;height:100px;padding:10px;">
                                                        <?php } else { ?>
                                                        <img src="<?php echo base_url(); ?>site_source/no-images.png" class="rounded-circle" style="width:100px;height:100px;padding:10px;">
                                                        <?php } ?>   
                                                    </center>
                                                </td>
                                                <td style="vertical-align: middle;"><?php echo $emp->LastName.', '.$emp->FirstName.' '.$emp->MiddleName; ?></td>
                                                <td style="vertical-align: middle;">
                                                        <?php echo $emp->EmployeeType; ?>
                                                </td>
                                                <td style="vertical-align: middle;">
                                                        <center>
<!--                                                        <div class="btn-group mb-2">
                                                            ...
                                                            <a href="<?php echo base_url('administrator/employee_view/'.$emp->EmployeeID); ?>" class="btn btn-info btn-sm">View <i class="fa fa-file"></i></a>
                                                            <a href="<?php echo base_url('administrator/employee_edit/'.$emp->EmployeeID); ?>" class="btn btn-warning btn-sm" >Edit <i class="fa fa-edit"></i></a>
                                                            <a href="<?php echo base_url('administrator/employee_delete/'.$emp->EmployeeID); ?>" class="btn btn-danger btn-sm"  onclick="return confirm('Are you sure you want to delete?');">Delete <i class="fa fa-trash"></i></a>
                                                </center>
                                                </td>
                                        </tr>
                                        <?php  }  ?>
                                    ...
                                    <div class="col-md-12">
                                            <div class="row">
                                                    <div class="col-md-12">
                                                            ...
                                                            <select name="employee_type" class="form-control input-sm" placeholder="Employee Type" data-toggle="tooltip" data-placement="top" title="Employee Type">
                                                                    <?php foreach ($employee_type as $emptype) { ?>
                                                                <option value="<?php echo $emptype->EmployeeTypeID; ?>"><?php echo ucwords(strtolower($emptype->EmployeeType)); ?></option>
                                                                    <?php } ?>
                                                            </select> 
