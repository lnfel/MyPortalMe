         ...
         <div class="row">
                    <div class="col-md-6">
                            <div class="float-left">    
                                <h2 class="section-title mt-0">Manage School Years</h2>
              ...
              <div class="table-responsive">
                   <div style="height:620px;overflow:auto;">
                        <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                        <?php $i=1; ?>
                                        <?php foreach ($cat_school_year as $sec) { ?>
                                                <tr>
                                                        <th style="vertical-align: middle;"><?php echo $sec->SchoolYearID ?></th>
                                                        <td style="vertical-align: middle;"><?php echo $sec->SchoolYearName; ?></td>
                                                        <td style="vertical-align: middle;"><?php echo $sec->PeriodID; ?></td>
                                                        <td style="vertical-align: middle;"><?php echo $sec->PeriodName; ?></td>
                                                        <td style="vertical-align: middle;"><?php echo $sec->EducLevelID; ?></td>
                                                        <td style="vertical-align: middle;">
                                                                <center>
                                                                <a href="<?php echo base_url('administrator/school_year_edit/'.$sec->SchoolYearID); ?>" class="btn btn-warning btn-sm" >Edit <i class="fa fa-edit"></i></a>
                                                                <a href="<?php echo base_url('administrator/school_year_delete/'.$sec->SchoolYearID); ?>" class="btn btn-danger btn-sm"  onclick="return confirm('Are you sure you want to delete?');">Delete <i class="fa fa-trash"></i></a>
                                                                </center>
                                                        </td>
                                                </tr>
                                        <?php  } ?>
