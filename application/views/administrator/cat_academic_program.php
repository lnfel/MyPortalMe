...
<!--                                                        <div class="btn-group mb-2">
                                                            ...
                                                            <a href="<?php echo base_url('administrator/student_view/'.$emp->ID); ?>" class="btn btn-info btn-sm">View <i class="fa fa-file"></i></a>
                                                            <a href="<?php echo base_url('administrator/student_edit/'.$emp->ID); ?>" class="btn btn-warning btn-sm" >Edit <i class="fa fa-edit"></i></a>
                                                            <a href="<?php echo base_url('administrator/student_delete/'.$emp->ID); ?>" class="btn btn-danger btn-sm"  onclick="return confirm('Are you sure you want to delete?');">Delete <i class="fa fa-trash"></i></a>
                                                </center>
                                                </td>
                                        </tr>
                                        <?php  }  ?>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="add_employee" class="btn btn-primary"><i class="fa fa-plus"></i> Add Academic Program</button>
                        </div>
                    </div>
                </div>
            </div>
