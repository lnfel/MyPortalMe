                    ...
                    <div class="row" >
                            ...
                            <div class="col-md-10">
                                    <div class="input-group mb-3">
                                            <input type="text" class="form-control" name="keyword" placeholder="Search Room " data-toggle="tooltip" data-placement="top" title="Search Room ">
                            ...
                            <?php //if($result->num_rows > 0){ ?>
                                        <?php //$i=1; do { ?>
                                                <tr>
                                                        ...
                                                        <td style="vertical-align: middle;"> <?php //echo $row['RoomID'].', '.$row['RoomCode'].' '.$row['RoomName']; ?></td>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row" >
                                    <div class="col-md-12">
                                            <div class="row">
                                                    <div class="col-md-12">
                                                            <label style="font-weight:bold;">Room ID</label>
                                                            <input type="text" name="RoomID" class="form-control" value="" placeholder="Room ID" data-toggle="tooltip" data-placement="top" title="Room ID" onkeyup="this.value = this.value.toUpperCase()" required>
                                                            <label style="font-weight:bold;">Room Code</label>
                                                            <input type="text" name="RoomCOde" class="form-control" value="" placeholder="Room Code" data-toggle="tooltip" data-placement="top" title="Room Code" onkeyup="this.value = this.value.toUpperCase()" required>
                                                            <label style="font-weight:bold;">Room Name</label>
                                                            <input type="text" name="RoomName" class="form-control" value="" placeholder="Room Name" data-toggle="tooltip" data-placement="top" title="Sear Capacity" onkeyup="this.value = this.value.toUpperCase()">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="add_employee" class="btn btn-primary"><i class="fa fa-plus"></i> Add Room </button>
                        </div>
                    </div>
                </div>
            </div>
